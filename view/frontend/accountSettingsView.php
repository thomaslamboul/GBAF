                ...
                <form method="post" action="index.php?action=settings" id="form_settings">
                    <fieldset>                  
                        ...
                        <div>
                            ...
                            <input type="text" name="lastnameSettings" value="<?=htmlspecialchars($userInfos['last_name'])?>">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="firstnameSettings" value="<?=htmlspecialchars($userInfos['first_name'])?>">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="usernameSettings" value="<?=htmlspecialchars($userInfos['username'])?>">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="password" name="newPasswordSettings" placeholder="Saisissez votre nouveau mot de passe">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="password" name="passwordConfirmationSettings" placeholder="Confirmer le nouveau mot de passe">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="questionSettings" value="<?=htmlspecialchars($userInfos['question'])?>">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="answerSettings" placeholder="Saisissez votre nouvelle réponse">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="password" name="passwordCurrentSettings" placeholder="Entrez votre mot de passe actuel" required="">
                        </div>
